...
* The final camera-ready pdf manuscript file of up to 10 MB must be uploaded.
  ...
  * Technical papers that were originally submitted to the Transactions on Haptics Short Paper track must be reformatted to use the [conference technical paper template](https://2020.hapticssymposium.org/presenting/technical-papers/). Please see the acceptance email for further details.
